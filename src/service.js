...
// const WEB_APP_URL = 'https://app.captaindata.co/';
// const API_URL = 'https://api.captaindata.co';
      ...
      async (cookieObjects) => {
        try {
          ...
          if (JSON.stringify(freshCookies) === "{}") {
            ...
            if ((!clientCookies || (clientCookies && JSON.stringify(clientCookies) === '{}'))) {
              resolve({
                success: true,
                message:
              ...
              // Allow captain to update account as invalid
